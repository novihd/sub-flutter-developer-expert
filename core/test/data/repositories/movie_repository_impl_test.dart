...
void main() {
  ...
  group('Popular Movies', () {
    ...
    group('when device is offline', () {
      ...
      test('should return cached data popular movie when device is offline',
          () async {
        // arrange
  ...
  group('Top Rated Movies', () {
    ...
    group('when device is online', () {
      ...
      test(
        ...
        verify(mockLocalDataSource.cacheTopMovies([testMovieCache]));
      });
    ...
    group('when device is offline', () {
      ...
      test('should return cached data popular movie when device is offline',
          () async {
        // arrange
        when(mockLocalDataSource.getCachedTopMovies())
            .thenAnswer((_) async => [testMovieCache]);
        // act
        final result = await repository.getTopRatedMovies();
        // assert
        verify(mockLocalDataSource.getCachedTopMovies());
        final resultList = result.getOrElse(() => []);
        expect(resultList, [testMovieFromCache]);
      });
